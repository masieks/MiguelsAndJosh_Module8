...
namespace MiguelsAndJosh_Module8
{
    public partial class frmMain : Form
    {
        ...
        //Arrays variables
        public string[] itemsNames = new string[SIZE];
        public int[] itemsQuantity = new int[SIZE];
        public double[] itemsPrice = new double[SIZE];
        ...
        private void btnCoke_Click(object sender, EventArgs e)
        {
            ...
            {
                lstOrderDisplay.Items.Add(lblCoke.Text + "     \t" + cbxCoke.Text + "     \t " + cokePrice);
